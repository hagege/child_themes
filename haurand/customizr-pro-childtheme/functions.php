...
function child_theme_styles() {
  ...
  wp_enqueue_style( 'additional-style', get_stylesheet_directory_uri() . '/posts_in_site.css' );
// die folgende Zeile ist wohl nicht notwendig: (wieder aktiviert wegen GTMetrix, hgg, 5.4.2021)
