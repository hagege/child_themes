<?php
	/**
		* Title: template-with-white-circle
		* Slug: circles-wp/template-with-white-circle
		* Inserter: no
	*/
?>
...
<main class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0"><!-- wp:group {"align":"full","style":{"background":{"backgroundImage":{"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/circle_white.svg","id":7612,"source":"file","title":"circle_white"},"backgroundPosition":"50% 0"},"dimensions":{"minHeight":"100vh"}},"layout":{"type":"constrained"}} -->
