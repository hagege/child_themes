<?php
	/**
		...
		* Slug: circles-wp/template-with-green-circle
		* Inserter: no
	*/
?>
...
<main class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0"><!-- wp:group {"align":"full","style":{"background":{"backgroundPosition":"50% 0","backgroundImage":{"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/circle_green.svg","id":7592,"source":"file","title":"circle_green"}},"dimensions":{"minHeight":"100vh"}},"layout":{"type":"constrained"}} -->
