	...
	<div class="wp-block-columns"><!-- wp:column {"width":"20%","layout":{"type":"constrained"}} -->
		<div class="wp-block-column" style="flex-basis:20%"><!-- wp:group {"align":"wide","className":"category_shortcode","style":{"position":{"type":"sticky","top":"0px"},"background":{"backgroundPosition":"50% 0"}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group alignwide category_shortcode"><!-- wp:spacer {"height":"70px"} -->
				...
				<!-- wp:heading {"level":3} -->
				<h3 class="wp-block-heading" id="h-kategorien"><?php esc_html_e('Categories', 'circles-wp');?></h3>
				<!-- /wp:heading -->
				...
				<h3 class="wp-block-heading alignwide" id="h-schlagworter"><?php esc_html_e('Tags', 'circles-wp');?></h3>
				<!-- /wp:heading -->
		...
		<!-- wp:column {"width":"80%"} -->
		<div class="wp-block-column" style="flex-basis:80%"><!-- wp:group {"tagName":"main","style":{"background":{"backgroundImage":{"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/circle_light_orange.svg","id":11792,"source":"file","title":"circle_light_orange"},"backgroundSize":"cover"}},"layout":{"type":"constrained"}} -->
