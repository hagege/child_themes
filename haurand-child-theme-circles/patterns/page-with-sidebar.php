 ...
 * Slug: haurand-child-theme-circles-wp/page-with-sidebar
 * Inserter: no
 */
?>
...
<!-- wp:group {"style":{"background":{"backgroundImage":{"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/circle_light_blue.svg","id":6935,"source":"file","title":"circle_light_blue"},"backgroundPosition":"50% 0"},"dimensions":{"minHeight":"100vh"}},"layout":{"type":"constrained"}} -->
