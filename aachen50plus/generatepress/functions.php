...
function filter_the_content_in_the_main_loop( $content ) {
    ...
    if (( is_single() OR is_page()) && in_the_loop() && is_main_query() ) {   
        ...
        if ( !is_front_page() ) {
          $abgesagte_events ='<div class="ackids_container"><div class="abgesagt"><a class="avia-button" href="https://aachenerkinder.de/corona-virus-staedteregion-aachen/">Infos zu Corona</a> - Bitte beachten: Im Dezember 2020 finden aufgrund der aktuellen Bestimmungen fast keine Veranstaltungen statt.</div></div>';
