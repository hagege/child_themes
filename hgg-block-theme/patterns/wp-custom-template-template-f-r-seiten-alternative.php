<?php
/**
 * Title: wp-custom-template-template-f-r-seiten-alternative
 * Slug: hgg-block-theme/wp-custom-template-template-f-r-seiten-alternative
 * Categories: hidden
 * Inserter: no
 */
?>
