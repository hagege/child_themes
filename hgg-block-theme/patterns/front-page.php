...
<h1 class="wp-block-heading has-text-align-center" style="font-size:10rem;text-transform:none"><?php esc_html_e('Das ist eine neue Startseite', 'hgg-block-theme');?></h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->
...
<div class="wp-block-cover alignfull"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-10 has-background-dim" style="background-color:#747370"></span><img class="wp-block-cover__image-background " alt="<?php esc_html_e('', 'hgg-block-theme');?>" src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/IMG_20200731_195858.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","fontSize":"large"} -->
