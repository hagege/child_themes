...
### ----------------------------- WICHTIG: Prüfen -------------------------------- ###
### ------------------------------------------------------------------------------ ###
# braucht in der Regel nicht geändert zu werden, sonst evtl. Laufwerk ändern
...
### ------------------------------------------------------------------------------ ###
	...
	# hat funktioniert, dauert aber lange - daher wenn möglich besser direkt lokal entpacken - klappt auch nur mit der PRO-Version:
	...
	# NinjaFirewall macht keinen Sinn und funktioniert auch nicht unter Windows
	...
	# alle Plugins aktivieren (evtl. später einzelne Plugins z. B. im Dashboard deaktivieren)
	php ../wp-cli.phar plugin activate --all;
	
	# lokal nicht genutzte Plugins deaktivieren, wenn nicht benötigt
	# wenn nicht vorhanden, kommentieren:
	...
	# timezone sicherheitshalber einstellen
	...
	echo "evtl. sicherheitshalber noch mal auf Einstellungen > Permalinks aktualisieren"
	echo "================================================================="
