...
wp_restore="backup_2022-10-23-0400_aachen50plusde_001dbe6acaf4"
...
search_string="https://aachen50plus.de" 
dbname="aachen50plus"
...
### -> done
	...
	# delete database (evtl. ausschalten)
	...
	php ../wp-cli.phar plugin install simple-myisam-to-innodb --activate
	...
	php ../wp-cli.phar option update blogname "LOKALE TESTSEITE ${dbname}"
