...
dir='haurand'
echo "================================================================="
echo "Wiederherstellung aus UpdraftPlus: $sitename"
echo "================================================================="
wp_restore='c49c0648eec8'
### -> done
	...
	# hier muss trotzdem ein User angegelgt werden, auch wenn der User nach der Wiederherstellung nicht mehr da ist und erst später wieder angelegt wird:
	...
	gzip -d -r d:/laragon/sicherungen/backup_2022-01-07-2232_WordPressWebseiten_c49c0648eec8-db.gz
	### ---------------------- WICHTIG: Korrekt ersetzen ---------------------- ###
	# -> Datenbank importieren
	php ../wp-cli.phar db import d:/laragon/sicherungen/backup_2022-01-07-2232_WordPressWebseiten_c49c0648eec8-db
	...
	unzip 'd:/laragon/sicherungen/backup_2022-01-07-2232_WordPressWebseiten_c49c0648eec8-*.zip' -d d:/laragon/www/haurand/wp-content
	...
	### ---------------------- WICHTIG: Korrekt ersetzen ---------------------- ###
	php ../wp-cli.phar search-replace "https://haurand.com" "http://localhost/haurand"
