<?php
	/**
		* Title: Hero
		* Slug: spacepress-wp/hero
		* Categories: spacepress-wp, call-to-action
	*/
?>
<!-- wp:cover {"overlayColor":"base","isUserOverlayColor":true,"isDark":false,"align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|base-2"}}}},"textColor":"base-2"} -->
