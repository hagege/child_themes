...
<h2 class="wp-block-heading" id="h-404-fehler"><?php esc_html_e('404', 'spacepress-wp');?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e('Sorry, unfortunately nothing found.', 'spacepress-wp');?></p>
<!-- /wp:paragraph -->
