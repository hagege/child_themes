<?php
	/**
		...
		* Slug: spacepress-wp/header-with-contact-row
		* Categories: header, spacepress-wp
...
<div class="wp-block-group has-contrast-background-color has-background"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"textColor":"base"} -->
	<p class="has-base-color has-text-color has-link-color"><?php esc_html_e('Tel.: 012345-67889 | Mail: test@example.com', 'spacepress-wp');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
