...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading" id="h-kategorien"><?php esc_html_e('Categories', 'spacepress-wp');?></h3>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading alignwide" id="h-schlagworter"><?php esc_html_e('Tags', 'spacepress-wp');?></h3>
<!-- /wp:heading -->
