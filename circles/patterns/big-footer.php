...
<div class="wp-block-group" style="border-top-color:var(--wp--preset--color--contrast-5);border-top-width:1px;padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--20)"><!-- wp:columns {"align":"wide"} -->
...
<h2 class="wp-block-heading has-medium-font-size has-lexend-font-family" style="font-style:normal;font-weight:600"><?php esc_html_e('Über uns', 'circles');?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:heading {"className":"has-medium-font-size","style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontFamily":"lexend"} -->
<h2 class="wp-block-heading has-medium-font-size has-lexend-font-family" style="font-style:normal;font-weight:600"><?php esc_html_e('Datenschutz', 'circles');?></h2>
<!-- /wp:heading -->
