<?php
	/**
		...
		* Slug: wp-simple-fse/posts-in-one-column
		* Categories: wp-simple-fse, query
		* Block Types: core/query
		* Description: Posts in one column. Can be inserted on pages. Do not use for posts.
	*/
?>
<!-- wp:group {"metadata":{"categories":["posts"],"patternName":"wp-simple-fse/posts-in-two-columns","name":"Posts in one column"},"align":"full","layout":{"type":"constrained"}} -->
