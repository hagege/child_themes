 ...
 * Slug: wp-simple-fse/single-post-with-sidebar
 * Inserter: no
 */
?>
...
<h2 class="wp-block-heading"><?php esc_html_e('Kommentare', 'wp-simple-fse');?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading" style="font-size:1.6rem"><?php esc_html_e('Beliebte Kategorien', 'wp-simple-fse');?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:heading {"style":{"typography":{"fontSize":"1.6rem"}}} -->
<h2 class="wp-block-heading" style="font-size:1.6rem"><?php esc_html_e('Nützliche Links', 'wp-simple-fse');?></h2>
<!-- /wp:heading -->

<!-- wp:list -->
<ul class="wp-block-list"><!-- wp:list-item -->
<li><?php esc_html_e('Ein erster Link', 'wp-simple-fse');?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php esc_html_e('Ein zweiter Link', 'wp-simple-fse');?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php esc_html_e('Ein dritter Link', 'wp-simple-fse');?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:heading {"style":{"typography":{"fontSize":"1.6rem"}}} -->
<h2 class="wp-block-heading" style="font-size:1.6rem"><?php esc_html_e('Die Website durchsuchen', 'wp-simple-fse');?></h2>
<!-- /wp:heading -->
