...
A plugin to post automatic per shortcode an actual PDF-File as link with option to uplod PDF-Files
...
4. Es sollte ein Ordner nur für den Upload der PDF-Dateien (wochenplan) gewählt werden können.
    > erledigt. Allerdings wird der Ordner (wochenplan) fest vorgegeben
