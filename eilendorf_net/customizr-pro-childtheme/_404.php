            ...
            <div class="<?php czr_fn_column_content_wrapper_class() ?>">
                ...
                <div id="content" class="<?php czr_fn_article_container_class() ?>">
                  ...
                  <?php
                    ...
                    ?>
                    <div>
                    <h4>Bubenheimer Spieleland</h4>
                    <p>Ob Regen oder Sonnenschein – Bubenheim lädt zum Spielen ein</p>
                    </div>
                    <?php
                    ...
                    <header class="entry-header text-center" <?php czr_fn_echo('element_attributes') ?>>
                      ...
                      <h2>Dieser Beitrag existiert leider nicht mehr</h2>
                    ...
                    <article id="post-0" class="post error404 no-results not-found row text-center">
                      <div class="tc-content col-12">
                        <div class="entry-content">
                          ...
                          <p align="left"><img class="size-medium wp-image-66574" src="https://bubenheimer-spieleland.de/wp-content/uploads/2019/10/Fragezeichen.jpg" align="right" alt="404" width="200" />hmm - leider war der Beitrag oder die Seite schon sehr alt und wir haben daher möglicherweise den Eintrag gelöscht.<br>
                            Im Interesse der Aktualität macht es bei manchen Beiträgen oder Seiten wenig Sinn, diese Beiträge ewig "mitzuschleppen".
                            ...
                            Möglicherweise erhältst du dann Treffer zu aktuelleren Beiträgen oder Seiten zu diesem Thema.<br>
                            <em>Grafik: Bubenheimer Spieleland </em>
                          </p>
